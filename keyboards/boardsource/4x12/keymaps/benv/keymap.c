...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_STENO] = LAYOUT_ortho_4x12(
    ...
    _______,   _______, _______, STN_A,   STN_O,      PB_3, STN_N2,  STN_E,   STN_U,   _______, _______, _______
  ),
  [_MODE] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______, _______, _______, _______, _______,  KC_SPC,  KC_TAB, _______, _______, _______
  )
};
